<template>
	<div class="container" ref="" :class="{active: menu}">
		...
		<div class="privacy">
			<section class="">
				<h2 class="privacy--title">privacy of Use</h2>
			...
			<section>
				<h3>INTRODUCTION AND ACCEPTANCE OF privacy</h3>
				<p class="privacy--body">
					Capsule, Inc. (collectively, "we," "us" or "Capsule") provides you access to the Capsule Services (defined below) subject to the privacy 
					and conditions described in this document (this "privacy of Use") and any other guidelines, rules or licenses posted in connection with 
					any Online Community (defined below). This privacy of Use also includes our Privacy Policy, incorporated by this reference.
					By using this Service, clicking “I Agree”, registering a User Account (defined below), purchasing an Online Community, 
					or by indicating your agreement to this privacy of Use through a similar mechanism, you are agreeing to be bound by this privacy of Use. 
					If you do not agree to this privacy of Use, do not use the Services. If you under the age of 18, but at least 13 years of age, 
					...
					and are fully able and competent to enter into all of the conditions, obligations, affirmations, representations and warranties set forth in this privacy of Use. 
				...
				<p class="privacy--body">
					...
					if you agree to abide by all applicable laws, rules, regulations, as well as this privacy of Use. You may access the Services as:
